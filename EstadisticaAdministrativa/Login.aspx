<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="EstadisticaAdministrativa.Login" %>
...
<%--                    <asp:Panel runat="server" CssClass="row m-0 p-3 d-flex align-items-center justify-content-center">
                        <asp:Label runat="server" CssClass="titulo_central_panel text-center font-weight-bold">SISTEMA DE ESTADISTICA</asp:Label>
                        <br />
                    </asp:Panel>--%>
                    <asp:Panel runat="server" CssClass="row m-0">
                        <asp:Label runat="server" CssClass="titulo_central_panel text-center font-weight-bold" style="margin: 0 auto;"> SISTEMA DE ESTADISTICA ADMINISTRATIVA</asp:Label>
                    </asp:Panel>
                    <asp:Panel runat="server" CssClass="row m-0">
